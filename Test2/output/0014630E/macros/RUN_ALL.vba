...
Sub Step01_F001()
    ...
    ' ---- SKETCH: circle dia 1.12 at (0, 0) drawing units ----
    swModel.SketchManager.CreateCircleByRadius 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, (1.12 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Cylindrical_base_boss_outer_diameter_1_1"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Cylindrical_base_boss_outer_diameter_1_1"
End Sub
...
Sub Step02_F002()
    ...
    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 0.656 (thru) ----
    swModel.SketchManager.CreateCircleByRadius 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, (0.656 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Concentric_through_hole_diameter_0_656_i"
    If Not VerifySolidBody("02_F002") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "02_F002", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "02_F002", "Created feature F002_Concentric_through_hole_diameter_0_656_i"
End Sub
...
Sub StepZZ_FinalVerify()
    ...
    ' Expected from the drawing: length=0.312
    ...
    MsgBox "Bounding box (drawing units): " & _
        ...
        "Drawing envelope: length=0.312" & vbCrLf & _
