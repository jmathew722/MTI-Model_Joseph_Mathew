...
Sub Step00_Setup()
    ...
    ' ---- SAVE AS A001601E.sldprt (next to the macros folder) ----
    Dim macroPath As String, savePath As String
    Dim saveErrs As Long, saveWarns As Long
    macroPath = swApp.GetCurrentMacroPathName
    savePath = Left$(macroPath, InStrRev(macroPath, "\")) & "..\A001601E.sldprt"
...
Sub Step01_F001()
    ...
    ' ---- SKETCH: rectangle 22 x 0.188, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 22) * UNIT_FACTOR, (0 + 0.188) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Base_flat_bar_22_00_long_x_0_75_tall_ext"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Base_flat_bar_22_00_long_x_0_75_tall_ext"
End Sub
...
Sub Step02_F002()
    ...
    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 5 hole(s) dia 0.281 (thru) ----
    swModel.SketchManager.CreateCircleByRadius 2 * UNIT_FACTOR, 0.375 * UNIT_FACTOR, 0#, (0.281 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 4.5 * UNIT_FACTOR, 0.375 * UNIT_FACTOR, 0#, (0.281 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 9 * UNIT_FACTOR, 0.375 * UNIT_FACTOR, 0#, (0.281 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 13.5 * UNIT_FACTOR, 0.375 * UNIT_FACTOR, 0#, (0.281 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 18 * UNIT_FACTOR, 0.375 * UNIT_FACTOR, 0#, (0.281 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_5x_281_diameter_through_holes_along_bar_"
    If Not VerifySolidBody("02_F002") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "02_F002", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "02_F002", "Created feature F002_5x_281_diameter_through_holes_along_bar_"
End Sub
...
Sub StepZZ_FinalVerify()
    ...
    ' Expected from the drawing: length=22; height=0.75; height=0.375; width=0.188
    ...
    MsgBox "Bounding box (drawing units): " & _
        ...
        "Drawing envelope: length=22; height=0.75; height=0.375; width=0.188" & vbCrLf & _
