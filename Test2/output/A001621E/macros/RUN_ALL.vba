...
Sub Step00_Setup()
    ...
    ' ---- SAVE AS A001621E.sldprt (next to the macros folder) ----
    Dim macroPath As String, savePath As String
    Dim saveErrs As Long, saveWarns As Long
    macroPath = swApp.GetCurrentMacroPathName
    savePath = Left$(macroPath, InStrRev(macroPath, "\")) & "..\A001621E.sldprt"
...
Sub Step01_F001()
    ...
    ' ---- SKETCH: rectangle 6 x 3, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 6) * UNIT_FACTOR, (0 + 3) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Rectangular_plate_base_body_6_00_long_si"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Rectangular_plate_base_body_6_00_long_si"
End Sub
...
Sub Step02_F003()
    ...
    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 1.09 (thru) ----
    swModel.SketchManager.CreateCircleByRadius 3 * UNIT_FACTOR, 1.75 * UNIT_FACTOR, 0#, (1.09 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F003_1_090_dia_through_hole_at_part_vertical_"
    If Not VerifySolidBody("02_F003") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "02_F003", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "02_F003", "Created feature F003_1_090_dia_through_hole_at_part_vertical_"
End Sub
...
Sub Step03_F002()
    ...
    swModel.SketchManager.CreateCircleByRadius 0.5 * UNIT_FACTOR, 1.75 * UNIT_FACTOR, 0#, (0.406 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 5.5 * UNIT_FACTOR, 1.75 * UNIT_FACTOR, 0#, (0.406 / 2#) * UNIT_FACTOR
    ' NOTE: Hole positions read from drawing.
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Two_0_406_dia_through_holes_on_horizonta"
    If Not VerifySolidBody("03_F002") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "03_F002", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "03_F002", "Created feature F002_Two_0_406_dia_through_holes_on_horizonta"
End Sub
...
Sub StepZZ_FinalVerify()
    ...
    ' Expected from the drawing: width=3; height=3.5; length=6
    ...
    MsgBox "Bounding box (drawing units): " & _
        ...
        "Drawing envelope: width=3; height=3.5; length=6" & vbCrLf & _
