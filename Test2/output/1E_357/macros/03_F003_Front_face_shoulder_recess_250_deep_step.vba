' ============================================================
' 03_F003 - extrude_cut: Front face shoulder recess ? .250"" deep step creating the inner shoulder ring visible in side vi
' Part: 1E 357
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "03_F003 - extrude_cut: Front face shoulder recess ? .250"" deep step creating the inner shoulder ring visible in side vi", "No active document"
        End
    End If
