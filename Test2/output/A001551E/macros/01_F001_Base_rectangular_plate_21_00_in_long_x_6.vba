' ============================================================
' 01_F001 - extrude_boss: Base rectangular plate ? 21.00 in long x 6.00 in tall x 0.50 in deep
' Part: A001551E
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "01_F001 - extrude_boss: Base rectangular plate ? 21.00 in long x 6.00 in tall x 0.50 in deep", "No active document"
        End
    End If
