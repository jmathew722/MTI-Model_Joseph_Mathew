...
Sub Step00_Setup()
    ...
    ' ---- SAVE AS 16247.sldprt (next to the macros folder) ----
    Dim macroPath As String, savePath As String
    Dim saveErrs As Long, saveWarns As Long
    macroPath = swApp.GetCurrentMacroPathName
    savePath = Left$(macroPath, InStrRev(macroPath, "\")) & "..\16247.sldprt"
...
Sub Step01_F001()
    ...
    ' ---- SKETCH: rectangle 1 x 1, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 1) * UNIT_FACTOR, (0 + 1) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Base_extrusion_of_the_channel_C_profile_"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Base_extrusion_of_the_channel_C_profile_"
End Sub
...
Sub Step02_F002()
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Stepped_notch_relief_cut_visible_at_the_"
    If Not VerifySolidBody("02_F002") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "02_F002", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "02_F002", "Created feature F002_Stepped_notch_relief_cut_visible_at_the_"
End Sub
...
Sub Step03_FilletsChamfers()
    ...
    ' ---- F003: FILLET R0.531 (Typical fillet radius of .531 R at the flange-to-web inside corners, both top and bottom junctions.) ----
    If swSelMgr.GetSelectedObjectCount2(-1) = 0 Then
        MsgBox "Select the edge(s) for fillet F003 (R0.531), then run again.", vbExclamation
    ...
    Else
        ...
        Else
            swFeatF003.Name = "F003_Typical_fillet_radius_of_531_R_at_the_fl"
            LogResult "PASS", "03_fillets_chamfers", "F003 fillet R0.531 applied"
        End If
        swModel.ClearSelection2 True
    End If
End Sub
...
Sub StepZZ_FinalVerify()
    ...
    ' Expected from the drawing: height=19.25
    ...
    MsgBox "Bounding box (drawing units): " & _
        ...
        "Drawing envelope: height=19.25" & vbCrLf & _
