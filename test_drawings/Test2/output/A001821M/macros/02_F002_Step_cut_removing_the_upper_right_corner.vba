' ============================================================
' 02_F002 - extrude_cut: Step cut removing the upper-right corner to form the L/stepped profile (width reduction from 4.50
' Part: A001821M
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "02_F002 - extrude_cut: Step cut removing the upper-right corner to form the L/stepped profile (width reduction from 4.50", "No active document"
        End
    End If
