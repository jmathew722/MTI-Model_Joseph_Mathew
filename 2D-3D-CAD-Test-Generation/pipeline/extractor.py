...
MULTIVIEW_USER_TEXT = (
    ...
    "bolt_circle_diameter, optional bolt_circle_center/start_angle, and qty. If the "
    "holes span only PART of the circle (not all the way around), set arc_angle to that "
    "total span in degrees (holes sit at both ends); leave arc_angle 360 for a full ring.\n"
