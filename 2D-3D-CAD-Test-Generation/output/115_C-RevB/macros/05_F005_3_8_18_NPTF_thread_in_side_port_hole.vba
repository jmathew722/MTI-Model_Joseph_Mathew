' ============================================================
' 05_F005 - thread: 3/8-18 NPTF thread in side port hole
' Part: 115 C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "05_F005 - thread: 3/8-18 NPTF thread in side port hole", "No active document"
        End
    End If
    ...
    If Not SelectRefPlane("Front Plane", 1) Then
        ...
        LogResult "FAIL", "05_F005", "Could not select Front Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 0.578125 (tapped) ----
    ...
    If swModel.SketchManager.ActiveSketch Is Nothing Then
        ...
        LogResult "FAIL", "05_F005", "No active sketch to build the feature from."
        End
    End If
    ...
    If swFeat Is Nothing Then
        ...
        LogResult "FAIL", "05_F005", "Feature creation returned Nothing - check the sketch."
        End
    End If
    swFeat.Name = "F005_3_8_18_NPTF_thread_in_side_port_hole"
    If Not VerifySolidBody("05_F005") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "05_F005", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "05_F005", "Created feature F005_3_8_18_NPTF_thread_in_side_port_hole"

    ' TODO: VERIFY API CALL - cosmetic thread for "3/8-18 NPTF"
    ...
    ' spec "3/8-18 NPTF". (InsertCosmeticThread3 exists but its argument
    ' shape was not verified against a documented example, so it is not scripted.)
    LogResult "WARN", "05_F005", "Apply cosmetic thread 3/8-18 NPTF manually - see macro comments"
End Sub
