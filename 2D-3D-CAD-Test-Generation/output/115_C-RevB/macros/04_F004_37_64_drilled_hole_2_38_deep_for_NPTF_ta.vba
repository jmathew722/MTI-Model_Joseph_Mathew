' ============================================================
' 04_F004 - hole: 37/64 drilled hole 2.38 deep for NPTF tapped side port
' Part: 115 C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "04_F004 - hole: 37/64 drilled hole 2.38 deep for NPTF tapped side port", "No active document"
        End
    End If
    ...
    If Not SelectRefPlane("Right Plane", 3) Then
        ...
        LogResult "FAIL", "04_F004", "Could not select Right Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: circle dia 0.578125 at (1.625, 1.375) drawing units ----
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F004_37_64_drilled_hole_2_38_deep_for_NPTF_ta"
    If Not VerifySolidBody("04_F004") Then
        ...
        End
    End If
    LogResult "PASS", "04_F004", "Created feature F004_37_64_drilled_hole_2_38_deep_for_NPTF_ta"
End Sub
