' ============================================================
' 03_F006 - hole: Two 37/64 counterbored holes 1.12 deep with 1.002 dia C'bore 0.111 deep
' Part: 115 C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "03_F006 - hole: Two 37/64 counterbored holes 1.12 deep with 1.002 dia C'bore 0.111 deep", "No active document"
        End
    End If
    ...
    If Not SelectRefPlane("Top Plane", 2) Then
        ...
        LogResult "FAIL", "03_F006", "Could not select Top Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 0.578125 (counterbore) ----
    swModel.SketchManager.CreateCircleByRadius 1.625 * UNIT_FACTOR, 1.375 * UNIT_FACTOR, 0#, (0.578125 / 2#) * UNIT_FACTOR
    ...
    If swModel.SketchManager.ActiveSketch Is Nothing Then
        ...
        LogResult "FAIL", "03_F006", "No active sketch to build the feature from."
        End
    End If
    ...
    If swFeat Is Nothing Then
        ...
        LogResult "FAIL", "03_F006", "Feature creation returned Nothing - check the sketch."
        End
    End If
    swFeat.Name = "F006_Two_37_64_counterbored_holes_1_12_deep_w"
    If Not VerifySolidBody("03_F006") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "03_F006", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "03_F006", "Created feature F006_Two_37_64_counterbored_holes_1_12_deep_w"

    ' ---- COUNTERBORE: concentric blind cut dia 1.002 x 0.111 deep ----
    ' ---- PLANE SELECTION (Top Plane; name auto-detected) ----
    If Not SelectRefPlane("Top Plane", 2) Then
        MsgBox "Could not select Top Plane (no reference plane found).", vbCritical
        LogResult "FAIL", "03_F006_cbore", "Could not select Top Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    swModel.SketchManager.CreateCircleByRadius 1.625 * UNIT_FACTOR, 1.375 * UNIT_FACTOR, 0#, (1.002 / 2#) * UNIT_FACTOR
    ...
    If swModel.SketchManager.ActiveSketch Is Nothing Then
        MsgBox "No active sketch to build the feature from.", vbCritical
        LogResult "FAIL", "03_F006_cbore", "No active sketch to build the feature from."
        End
    End If
    ...
    If swFeatCb Is Nothing Then
        ...
        LogResult "FAIL", "03_F006", "Counterbore cut failed."
        End
    End If
    swFeatCb.Name = "F006_cbore"
    LogResult "PASS", "03_F006", "Counterbore created"
End Sub
