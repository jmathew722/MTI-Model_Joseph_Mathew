...
Sub main()
    ...
    ' Expected from the drawing: length=3.25; width=2.75; width=1.5; height=1.38; length=0.75
    ...
    MsgBox "Bounding box (drawing units): " & _
        ...
        "Drawing envelope: length=3.25; width=2.75; width=1.5; height=1.38; length=0.75" & vbCrLf & _
