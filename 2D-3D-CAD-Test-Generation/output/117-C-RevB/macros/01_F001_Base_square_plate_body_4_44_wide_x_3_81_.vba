' ============================================================
' 01_F001 - extrude_boss: Base square plate body, 4.44 wide x 3.81 tall x 1.00 thick with corner radii
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "01_F001 - extrude_boss: Base square plate body, 4.44 wide x 3.81 tall x 1.00 thick with corner radii", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: rectangle 4.44 x 3.81, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 4.44) * UNIT_FACTOR, (0 + 3.81) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Base_square_plate_body_4_44_wide_x_3_81_"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Base_square_plate_body_4_44_wide_x_3_81_"
End Sub
