' ============================================================
' 03_F003 - hole: Two 9/32 blind holes 0.31 deep
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "03_F003 - hole: Two 9/32 blind holes 0.31 deep", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 1 hole(s) dia 0.28125 (blind) ----
    swModel.SketchManager.CreateCircleByRadius 2.22 * UNIT_FACTOR, 1.905 * UNIT_FACTOR, 0#, (0.28125 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F003_Two_9_32_blind_holes_0_31_deep"
    If Not VerifySolidBody("03_F003") Then
        ...
        End
    End If
    LogResult "PASS", "03_F003", "Created feature F003_Two_9_32_blind_holes_0_31_deep"
End Sub
