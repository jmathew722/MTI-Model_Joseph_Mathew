' ============================================================
' 04_F004 - hole: Two center counterbored ports: 29/32 dia x 0.50 deep pilot with 1.311 cbore x 0.111 deep
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "04_F004 - hole: Two center counterbored ports: 29/32 dia x 0.50 deep pilot with 1.311 cbore x 0.111 deep", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 1 hole(s) dia 0.90625 (counterbore) ----
    swModel.SketchManager.CreateCircleByRadius 2.22 * UNIT_FACTOR, 1.905 * UNIT_FACTOR, 0#, (0.90625 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F004_Two_center_counterbored_ports_29_32_dia_"
    If Not VerifySolidBody("04_F004") Then
        ...
        End
    End If
    LogResult "PASS", "04_F004", "Created feature F004_Two_center_counterbored_ports_29_32_dia_"

    ' ---- COUNTERBORE: concentric blind cut dia 1.311 x 0.111 deep ----
    ' ---- PLANE SELECTION (Front Plane; name auto-detected) ----
    If Not SelectRefPlane("Front Plane", 1) Then
        MsgBox "Could not select Front Plane (no reference plane found).", vbCritical
    ...
    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    swModel.SketchManager.CreateCircleByRadius 2.22 * UNIT_FACTOR, 1.905 * UNIT_FACTOR, 0#, (1.311 / 2#) * UNIT_FACTOR
