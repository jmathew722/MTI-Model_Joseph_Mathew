' ============================================================
' 01_F001 - extrude_boss: Rectangular key plate, 3.00 long x 1.000 wide x 1.00 thick
' Part: 135-A
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "01_F001 - extrude_boss: Rectangular key plate, 3.00 long x 1.000 wide x 1.00 thick", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: rectangle 3 x 1, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 3) * UNIT_FACTOR, (0 + 1) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Rectangular_key_plate_3_00_long_x_1_000_"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Rectangular_key_plate_3_00_long_x_1_000_"
End Sub
