' ============================================================
' 03_F002 - hole: Counterbore holes (2 places): DRILL .58 DIA. x .50 DP, C'BORE 1.012/1.002 DIA. x .111/.113 DEEP
' Part: 116-C-Rev90B
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "03_F002 - hole: Counterbore holes (2 places): DRILL .58 DIA. x .50 DP, C'BORE 1.012/1.002 DIA. x .111/.113 DEEP", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 1 hole(s) dia 0.58 (counterbore) ----
    swModel.SketchManager.CreateCircleByRadius 1.625 * UNIT_FACTOR, 1.375 * UNIT_FACTOR, 0#, (0.58 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Counterbore_holes_2_places_DRILL_58_DIA_"
    If Not VerifySolidBody("03_F002") Then
        ...
        End
    End If
    LogResult "PASS", "03_F002", "Created feature F002_Counterbore_holes_2_places_DRILL_58_DIA_"

    ' ---- COUNTERBORE: concentric blind cut dia 1.007 x 0.112 deep ----
    ' ---- PLANE SELECTION (Front Plane; name auto-detected) ----
    If Not SelectRefPlane("Front Plane", 1) Then
        MsgBox "Could not select Front Plane (no reference plane found).", vbCritical
        LogResult "FAIL", "03_F002_cbore", "Could not select Front Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    swModel.SketchManager.CreateCircleByRadius 1.625 * UNIT_FACTOR, 1.375 * UNIT_FACTOR, 0#, (1.007 / 2#) * UNIT_FACTOR
    ...
    If swModel.SketchManager.ActiveSketch Is Nothing Then
        MsgBox "No active sketch to build the feature from.", vbCritical
        LogResult "FAIL", "03_F002_cbore", "No active sketch to build the feature from."
        End
    End If
    ...
    If swFeatCb Is Nothing Then
        ...
        LogResult "FAIL", "03_F002", "Counterbore cut failed."
        End
    End If
    swFeatCb.Name = "F002_cbore"
    LogResult "PASS", "03_F002", "Counterbore created"
End Sub
