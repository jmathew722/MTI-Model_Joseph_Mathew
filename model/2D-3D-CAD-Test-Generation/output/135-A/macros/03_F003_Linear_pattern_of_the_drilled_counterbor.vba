' ============================================================
' 03_F003 - pattern: Linear pattern of the drilled/counterbored hole, 2 instances spaced 2.000 apart
' Part: 135-A
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "03_F003 - pattern: Linear pattern of the drilled/counterbored hole, 2 instances spaced 2.000 apart", "No active document"
        End
    End If
    ' Pattern F003 is ALREADY SATISFIED: feature F002 cut all
    ' 2 instance(s) as separate circles in one sketch, so there is nothing
    ' left to pattern. This macro just records that and moves on.
    LogResult "PASS", "03_F003", "F003 pattern already realized by F002 (2 instances) - no action needed"
End Sub
