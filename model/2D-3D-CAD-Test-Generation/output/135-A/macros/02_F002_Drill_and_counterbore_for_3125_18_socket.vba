' ============================================================
' 02_F002 - hole: Drill and counterbore for .3125-18 socket head cap screw, 2 holes thru
' Part: 135-A
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "02_F002 - hole: Drill and counterbore for .3125-18 socket head cap screw, 2 holes thru", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 2 hole(s) dia 0.3125 (counterbore) ----
    swModel.SketchManager.CreateCircleByRadius 0.5 * UNIT_FACTOR, 0.5 * UNIT_FACTOR, 0#, (0.3125 / 2#) * UNIT_FACTOR
    swModel.SketchManager.CreateCircleByRadius 2.5 * UNIT_FACTOR, 0.5 * UNIT_FACTOR, 0#, (0.3125 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Drill_and_counterbore_for_3125_18_socket"
    If Not VerifySolidBody("02_F002") Then
        ...
        End
    End If
    LogResult "PASS", "02_F002", "Created feature F002_Drill_and_counterbore_for_3125_18_socket"
End Sub
