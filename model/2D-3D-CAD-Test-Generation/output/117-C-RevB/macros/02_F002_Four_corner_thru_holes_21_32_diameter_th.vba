' ============================================================
' 02_F002 - hole: Four corner thru holes 21/32 diameter through full thickness
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "02_F002 - hole: Four corner thru holes 21/32 diameter through full thickness", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 1 hole(s) dia 0.65625 (thru) ----
    swModel.SketchManager.CreateCircleByRadius 2.22 * UNIT_FACTOR, 1.905 * UNIT_FACTOR, 0#, (0.65625 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F002_Four_corner_thru_holes_21_32_diameter_th"
    If Not VerifySolidBody("02_F002") Then
        ...
        End
    End If
    LogResult "PASS", "02_F002", "Created feature F002_Four_corner_thru_holes_21_32_diameter_th"
End Sub
