' ============================================================
' 05_F005 - hole: Two 1/4 dia dowel holes 0.50 deep on side face
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "05_F005 - hole: Two 1/4 dia dowel holes 0.50 deep on side face", "No active document"
        End
    End If
    ...
    If Not SelectRefPlane("Right Plane", 3) Then
        ...
        LogResult "FAIL", "05_F005", "Could not select Right Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 0.25 (blind) ----
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F005_Two_1_4_dia_dowel_holes_0_50_deep_on_sid"
    If Not VerifySolidBody("05_F005") Then
        ...
        End
    End If
    LogResult "PASS", "05_F005", "Created feature F005_Two_1_4_dia_dowel_holes_0_50_deep_on_sid"
End Sub
