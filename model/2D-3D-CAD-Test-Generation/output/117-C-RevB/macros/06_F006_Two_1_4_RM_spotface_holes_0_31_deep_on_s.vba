' ============================================================
' 06_F006 - hole: Two 1/4 RM spotface holes 0.31 deep on side face
' Part: 117-C-RevB
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "06_F006 - hole: Two 1/4 RM spotface holes 0.31 deep on side face", "No active document"
        End
    End If
    ...
    If Not SelectRefPlane("Right Plane", 3) Then
        ...
        LogResult "FAIL", "06_F006", "Could not select Right Plane (no reference plane found)."
        End
    End If

    ' ---- OPEN SKETCH ----
    swModel.SketchManager.InsertSketch True
    ' ---- SKETCH: 1 hole(s) dia 0.25 (spotface) ----
    swModel.SketchManager.CreateCircleByRadius 2.22 * UNIT_FACTOR, 1.905 * UNIT_FACTOR, 0#, (0.25 / 2#) * UNIT_FACTOR
    ...
    If swModel.SketchManager.ActiveSketch Is Nothing Then
        ...
        LogResult "FAIL", "06_F006", "No active sketch to build the feature from."
        End
    End If
    ...
    If swFeat Is Nothing Then
        ...
        LogResult "FAIL", "06_F006", "Feature creation returned Nothing - check the sketch."
        End
    End If
    swFeat.Name = "F006_Two_1_4_RM_spotface_holes_0_31_deep_on_s"
    If Not VerifySolidBody("06_F006") Then
        MsgBox "No solid body after this feature.", vbCritical
        LogResult "FAIL", "06_F006", "No solid body after this feature."
        End
    End If
    LogResult "PASS", "06_F006", "Created feature F006_Two_1_4_RM_spotface_holes_0_31_deep_on_s"
End Sub
