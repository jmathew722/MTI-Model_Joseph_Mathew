' ============================================================
' 02_F003 - hole: .40 DIA. THRU holes, 4 places, arranged in bolt pattern 1.88 x 1.88 spacing
' Part: 116-C-Rev90B
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "02_F003 - hole: .40 DIA. THRU holes, 4 places, arranged in bolt pattern 1.88 x 1.88 spacing", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: 1 hole(s) dia 0.4 (thru) ----
    swModel.SketchManager.CreateCircleByRadius 1.625 * UNIT_FACTOR, 1.375 * UNIT_FACTOR, 0#, (0.4 / 2#) * UNIT_FACTOR
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F003_40_DIA_THRU_holes_4_places_arranged_in_b"
    If Not VerifySolidBody("02_F003") Then
        ...
        End
    End If
    LogResult "PASS", "02_F003", "Created feature F003_40_DIA_THRU_holes_4_places_arranged_in_b"
End Sub
