' ============================================================
' 01_F001 - extrude_boss: Base rectangular block body, overall 2.38 wide x 2.75 tall (top view); depth/thickness shown in 
' Part: 116-C-Rev90B
...
Sub main()
    ...
    If swModel Is Nothing Then
        ...
        LogResult "FAIL", "01_F001 - extrude_boss: Base rectangular block body, overall 2.38 wide x 2.75 tall (top view); depth/thickness shown in ", "No active document"
        End
    End If
    ...
    ' ---- SKETCH: rectangle 3.25 x 2.75, lower-left corner at (0, 0) ----
    ...
    swModel.SketchManager.CreateCornerRectangle 0 * UNIT_FACTOR, 0 * UNIT_FACTOR, 0#, _
        (0 + 3.25) * UNIT_FACTOR, (0 + 2.75) * UNIT_FACTOR, 0#
    ...
    If swFeat Is Nothing Then
        ...
        End
    End If
    swFeat.Name = "F001_Base_rectangular_block_body_overall_2_38"
    If Not VerifySolidBody("01_F001") Then
        ...
        End
    End If
    LogResult "PASS", "01_F001", "Created feature F001_Base_rectangular_block_body_overall_2_38"
End Sub
